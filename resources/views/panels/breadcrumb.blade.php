    ...
    <div class="row">
      ...
      <div class="col s12 m6 l6 right-align-md">
        ...
        <ol class="breadcrumbs mb-0">
          ...
          <li class="breadcrumb-item {{ !isset($breadcrum['link']) ? 'active' :''}}">
            @if(isset($breadcrum['link']) && $breadcrum['link'] !== 'javascript:void(0)')
            <a href="{{url($breadcrum['link'])}}">@endif{{$breadcrum['name']}}@if(isset($breadcrum['link']))</a>
            @endif
          </li>
          @endforeach
        </ol>
