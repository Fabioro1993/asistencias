...
class RegistroResumenEditComponent extends Component
{
    public $id_registro, $arry;
    ...
    public function mount($id_registro, $array)
    {
    ...
    public function render()
    {
        ...
        return view('livewire.registro.registro-resumen-edit-component', compact('registro_cab', 'fecha_max'));
    }
